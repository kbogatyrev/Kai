...
#define ERROR_TRACE(str_msg) (B_WriteTraceMsg (ec_ErrorTraceMsg, \
                              _T(__FILE__), \
                              __LINE__, \
                              _T(__FUNCTION__), \
                              str_msg));
#define INFO_TRACE(str_msg) (B_WriteTraceMsg (ec_InfoTraceMsg, \
                             _T(__FILE__), \
                             __LINE__, \
                             _T(__FUNCTION__), \
                             str_msg));
#define DUMP_TRACE(str_msg) (B_TraceOutput (str_msg));
